...
(function () {
    ...
    const PEPTIDES = [
        ...
        },
        {
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Long-acting GHRH · once weekly'
        },
        {
            id: 'cagrisema',
            name: 'CagriSema',
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Weekly amylin + GLP-1 · titrate q4wk'
        },
        {
            id: 'survo',
            name: 'Survodutide',
            page: 'survodutide.html',
            halfLifeHours: 112,
            defaultIntervalDays: 7,
            unit: 'mg',
            defaultDose: 0.3,
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Weekly GLP-1/glucagon · titrate slowly'
        },
        {
            id: 'mazi',
            name: 'Mazdutide',
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Weekly GLP-1/glucagon · 2-step titration'
        },
        {
            id: 'reta-cagri',
            name: 'Retatrutide + Cagrilintide',
            page: 'retatrutide-cagrilintide.html',
            halfLifeHours: 144,
            defaultIntervalDays: 7,
            unit: 'mg',
            defaultDose: 0.5,
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Weekly triple + amylin stack · go slow'
        },
        {
            id: '5amino',
            name: '5-Amino-1MQ',
            page: '5-amino-1mq.html',
            halfLifeHours: 12,
            defaultIntervalDays: 1,
            unit: 'mg',
            defaultDose: 1,
            ...
            defaultDays: [1, 2, 3, 4, 5],
            defaultStopWeeks: 8,
            note: 'Daily AM (5/2) · 0.5→1→2 mg · 4–8 wk then break'
        },
        {
            id: 'ghrp2',
            name: 'GHRP-2',
            ...
            defaultTimesPerDay: 2,
            defaultTimes: defaultAlertTimes(2),
            note: 'GH pulse · ~100 mcg 1–3× daily, empty stomach'
        },
        {
            id: 'ghrp6',
            name: 'GHRP-6',
            ...
            defaultTimesPerDay: 2,
            defaultTimes: defaultAlertTimes(2),
            note: 'GH pulse + appetite · ~100 mcg 1–3× daily'
        },
        {
            id: 'mgf',
            name: 'MGF',
            ...
            defaultTimes: defaultAlertTimes(1),
            defaultDays: [1, 3, 5],
            note: 'Post-workout on training days · short-acting'
        },
        {
            id: 'pegmgf',
            name: 'PEG-MGF',
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: '2–3× weekly · extended release'
        },
        {
            id: 'igf1lr3',
            name: 'IGF-1 LR3',
            ...
            defaultTimes: defaultAlertTimes(1),
            defaultDays: [1, 2, 3, 4, 5],
            note: 'Daily · 20–50 mcg · short blocks'
        },
        {
            id: 'pe2228',
            name: 'PE-22-28',
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Daily research dose · experimental'
        },
        {
            id: 'pinealon',
            name: 'Pinealon',
        ...
        },
        {
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Before bed · 200–500 mcg, 2–5× weekly'
        },
        {
            id: 'ta1',
            name: 'Thymosin Alpha-1',
            page: 'thymosin-alpha-1.html',
            halfLifeHours: 2,
            defaultIntervalDays: 3,
            unit: 'mg',
            defaultDose: 1.5,
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: '2–3× weekly · immune modulator'
        },
        {
            id: 'thymalin',
            name: 'Thymalin',
            ...
            defaultTimes: defaultAlertTimes(1),
            defaultStopWeeks: 2,
            note: '~10-day daily course · repeat seasonally'
        },
        {
            id: 'll37',
            name: 'LL-37',
            ...
            defaultTimes: defaultAlertTimes(1),
            defaultDays: [1, 2, 3, 4, 5],
            note: '5/2 daily · 2–4 week blocks'
        },
        {
            id: 'vip',
            name: 'VIP',
            ...
            defaultTimes: defaultAlertTimes(4),
            note: 'Nasal · 50 mcg up to 4× daily'
        },
        {
            id: 'mt2',
            name: 'Melanotan II',
            page: 'melanotan-2.html',
            halfLifeHours: 24,
            defaultIntervalDays: 1,
            unit: 'mcg',
            defaultDose: 250,
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Daily loading → maintenance · pair with sun'
        },
        {
            id: 'mt1',
            name: 'Melanotan-1',
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Daily loading phase · MC1R-selective tan'
        },
        {
            id: 'ss31',
            name: 'SS-31',
            ...
            defaultTimes: defaultAlertTimes(1),
            defaultStopWeeks: 4,
            note: 'Daily repair phase 2–5 mg · then 2–3× wk'
        },
        {
            id: 'pnc27',
            name: 'PNC-27',
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Experimental research peptide'
        },
        {
            id: 'hcg',
            name: 'HCG',
        ...
        },
        {
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Weekly lipotropic shot · premixed (mL)'
        },
        {
            id: 'lipoc',
            name: 'Lipo-C',
            ...
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: '1–2× weekly lipotropic shot · premixed (mL)'
        },
        {
            id: 'lcarn',
            name: 'L-Carnitine',
            page: 'l-carnitine.html',
            halfLifeHours: 24,
            defaultIntervalDays: 1,
            unit: 'mg',
            defaultDose: 500,
            defaultTimesPerDay: 1,
            defaultTimes: defaultAlertTimes(1),
            note: 'Daily / pre-workout · 500–1000 mg'
        },
        {
            id: 'bpc-tb',
            name: 'BPC-157 + TB-500',
            page: 'bpc-157-tb-500.html',
            halfLifeHours: 24,
            defaultIntervalDays: 1,
            unit: 'mg',
            defaultDose: 1,
            defaultTimesPerDay: 2,
            defaultTimes: defaultAlertTimes(2),
            note: 'Wolverine blend · 0.5–1 mg · 1–2× daily'
        },
        {
            id: 'nad',
            name: 'NAD+',
